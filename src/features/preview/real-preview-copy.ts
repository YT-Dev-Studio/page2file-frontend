  ...
  de: {
    status: {
      accepted: {
        ...
        text: "Die temporäre Konvertierung wurde angelegt.",
        tone: "progress",
        pending: true,
      },
      queued: {
      ...
      loading: {
        ...
        text: "Das Ziel wird erneut geprüft, während Ressourcen innerhalb fester Grenzen laden.",
        tone: "progress",
        pending: true,
      },
      analyzing: {
      ...
      preview_rendering: {
        ...
        text: "Temporäre Miniaturen für Seiten oder Folien werden erzeugt.",
        tone: "progress",
        pending: true,
      },
      preview_ready: {
        title: "Vorschau bereit",
        text: "Prüfen Sie Abschnitte und sichtbare Ersatzdarstellungen vor der endgültigen Ausgabe.",
        tone: "success",
        pending: false,
      },
      final_queued: {
        title: "Endgültige Ausgabe vorgemerkt",
        text: "Die bestätigte Vorschauversion wartet auf einen Worker.",
        tone: "progress",
        pending: true,
      },
      final_rendering: {
        title: "Endgültige Datei wird erstellt",
        text: "Das Dokument verwendet dieselbe Vorschauversion, die hier angezeigt wird.",
        tone: "progress",
        pending: true,
      },
      download_ready: {
      ...
      failed_terminal: {
        ...
        text: "Die übermittelte Seite konnte innerhalb der Sicherheitsgrenzen nicht verarbeitet werden.",
        tone: "error",
        pending: false,
      },
      cancelled: {
        title: "Konvertierung abgebrochen",
        text: "Ausstehende Arbeit wurde beendet; temporäre Daten werden entfernt.",
        tone: "warning",
        pending: false,
      },
      expired: {
        title: "Vorschau abgelaufen",
        text: "Temporäre Aufträge werden nicht als Konvertierungsverlauf gespeichert.",
        tone: "error",
        pending: false,
      },
    },
    ...
    inspectorTitle: "Prüfbereich",
    globalWarningsTitle: "Konvertierungswarnungen",
    noWarnings: "Für diesen Abschnitt liegen keine Warnungen vor.",
    ...
    renderFinal: "Endgültige Datei erstellen",
    ...
    warnings: {
      RASTER_FALLBACK: "Ein komplexes Element wurde als Bild ausgegeben.",
      FONT_SUBSTITUTED: "Eine Webschrift wurde durch eine sichere Dokumentschrift ersetzt.",
      RESOURCE_OMITTED: "Eine Ressource außerhalb des sicheren Budgets wurde ausgelassen.",
      STABILIZATION_INCOMPLETE:
        "Die Seite wurde vor der Erfassung nicht vollständig inaktiv.",
      LINK_REMOVED: "Ein unsicherer oder nicht unterstützter Link wurde entfernt.",
      CRAWL_PAGE_SKIPPED: "Ein Crawl-Ziel wurde wegen Umfang oder robots-Regeln übersprungen.",
    },
    ...
    returnToPreview: "Zur Vorschau zurückkehren",
  },
};
