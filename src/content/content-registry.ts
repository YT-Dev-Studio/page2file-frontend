...
export const blogEntries: ReadonlyArray<ContentEntry> = [
  {
    ...
    description: "Save a public or signed-in webpage as PDF, choose visual or editable output, review page breaks, and understand the temporary preview boundary.",
  ...
  },
  {
    ...
    description: "Learn when webpage links remain clickable in PDF, why visual capture flattens interaction, and how editable mode handles safe link targets.",
    author: "Page 2 File editorial",
  ...
  },
  {
    ...
    imageAlt: "A visual webpage compared with editable document blocks",
    title: "Visual vs Editable Webpage Conversion",
    description: "Choose between faithful visual capture and editable webpage conversion by comparing text, links, images, charts, layouts, and PowerPoint output.",
    author: "Page 2 File editorial",
  ...
  },
  {
    ...
    description: "Convert accessible website pages into separate PowerPoint files, keep the page boundary explicit, and review visual or editable slide output.",
    author: "Page 2 File editorial",
    publishedAt: "2026-08-02",
    updatedAt: "2026-08-02",
    readingMinutes: 6,
  ...
  },
  {
    ...
    description: "Move rendered HTML web content into PowerPoint by selecting useful sections, choosing visual or editable slides, and reviewing complex fallbacks.",
    author: "Page 2 File editorial",
    publishedAt: "2026-08-02",
    updatedAt: "2026-08-02",
    readingMinutes: 6,
  ...
  },
  {
    ...
    description: "Use webpage hierarchy to set slide boundaries, preserve context, split dense sections, and review visual or editable PowerPoint output.",
    author: "Page 2 File editorial",
  ...
  },
  {
    ...
    description: "Choose webpage capture for a readable visual document or web scraping for structured data, and avoid treating Page 2 File as a crawler API.",
    author: "Page 2 File editorial",
    publishedAt: "2026-08-02",
    updatedAt: "2026-08-02",
    readingMinutes: 6,
  ...
  },
  {
    ...
    description: "Prepare a visible ChatGPT conversation, load the needed range, choose visual or editable PDF, and distinguish tab capture from account export.",
    author: "Page 2 File editorial",
    publishedAt: "2026-08-02",
    updatedAt: "2026-08-02",
    readingMinutes: 6,
  ...
  },
  {
    ...
    description: "Prepare a Telegram Web chat or channel, load replies and media, choose visual or editable PDF, and review the captured message boundary.",
    author: "Page 2 File editorial",
    publishedAt: "2026-08-02",
    updatedAt: "2026-08-02",
    readingMinutes: 6,
...
const russianBlogEntries: ReadonlyArray<ContentEntry> = [
  {
    ...
    description: "Сохраните открытую или закрытую веб-страницу в PDF, выберите визуальный или редактируемый режим и проверьте разрывы в предпросмотре.",
  ...
  },
  {
    ...
    description: "Разберитесь, когда ссылки остаются кликабельными в PDF, почему визуальный захват убирает интерактивность и как работает редактируемый режим.",
    author: "Редакция Page 2 File",
    publishedAt: "2026-07-02",
    updatedAt: "2026-08-02",
    readingMinutes: 6,
  ...
  },
  {
    ...
    slug: "visual-vs-editable",
    image: "/blog/mocks/visual-vs-editable.webp",
    imageAlt: "Визуальная веб-страница сравнивается с редактируемыми блоками",
    title: "Визуальная и редактируемая конвертация веб-страниц",
    description: "Сравните визуальный захват и редактируемую конвертацию по тексту, ссылкам, изображениям, графикам, макетам и результату PowerPoint.",
    author: "Редакция Page 2 File",
    publishedAt: "2026-07-03",
    updatedAt: "2026-08-02",
    readingMinutes: 6,
  ...
  },
  {
    ...
    description: "Конвертируйте доступные страницы сайта в отдельные презентации PowerPoint, соблюдайте границы и проверяйте визуальные или редактируемые слайды.",
    author: "Редакция Page 2 File",
    publishedAt: "2026-08-02",
    updatedAt: "2026-08-02",
    readingMinutes: 6,
  ...
  },
  {
    ...
    description: "Выберите захват для читаемого визуального документа или парсинг для структурированных данных и не путайте Page 2 File с crawler API.",
    author: "Редакция Page 2 File",
    publishedAt: "2026-08-02",
    updatedAt: "2026-08-02",
    readingMinutes: 6,
