...
> = {
  "page2pdf-gpt": {
    ...
    title: "Converti un URL pubblico in PDF con One Page 2 PDF",
    description:
      "One Page 2 PDF è un’app GPT specializzata che invia un URL pubblico per la conversione e restituisce un PDF di quella singola pagina.",
    lead:
      "Fornisci all’app GPT un URL HTTPS pubblico. One Page 2 PDF invia l’indirizzo al servizio Page 2 File e restituisce un PDF scaricabile della pagina richiesta.",
    sections: [
      { heading: "1. Invia un URL pubblico", body: "Incolla l’indirizzo HTTPS esatto della pagina da convertire. La richiesta riguarda una pagina e non avvia una ricerca nell’intero sito." },
      { heading: "2. Ricevi un PDF", body: "L’app GPT restituisce un link a un PDF della pagina. Verifica testo, link, immagini e interruzioni di pagina prima di usare il file." },
      { heading: "3. Usa il limite corretto", body: "One Page 2 PDF non apre schede con accesso effettuato e non aggira i controlli di accesso. Usa l’estensione Page 2 File per una pagina già aperta dopo l’accesso." },
    ],
    externalLinkKey: "page2pdfGpt",
    primaryLabel: "Apri l’app GPT One Page 2 PDF",
    articleLinks: [
  ...
  "html2pdf-gpt": {
    ...
    title: "Converti un file HTML caricato con HTML 2 PDF",
    description:
      "HTML 2 PDF accetta un file HTML caricato e restituisce un PDF ordinato entro limiti di rendering visibili.",
    lead:
      "Carica un file HTML nell’app GPT. HTML 2 PDF lo renderizza in isolamento e restituisce un PDF; questo flusso per file HTML originale è disponibile solo nell’app.",
    sections: [
      { heading: "1. Carica il file HTML", body: "Aggiungi il documento HTML che sei autorizzato a elaborare. Questo flusso inizia con un file, non con l’URL pubblico di una pagina web." },
      { heading: "2. Convertilo in PDF", body: "L’app restituisce un PDF del documento caricato. Risorse esterne, script, font personalizzati e funzioni del browser possono variare." },
      { heading: "3. Considera l’HTML un input non attendibile", body: "Il rendering sicuro richiede l’isolamento di reti private, file locali e script non controllati. Il risultato è una conversione del documento, non un’esecuzione web ospitata." },
    ],
    externalLinkKey: "html2pdfGpt",
    primaryLabel: "Apri l’app GPT HTML 2 PDF",
    articleLinks: [
