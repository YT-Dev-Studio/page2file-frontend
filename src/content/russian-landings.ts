...
> = {
  "chrome-extension": {
    ...
    lead: "Используйте расширение для страниц с авторизацией, закрытых диалогов и материалов, которые нельзя отправлять удалённому сервису конвертации.",
    sections: [
      {
        heading: "Осознанная модель разрешений",
        body: "Page2File получает временный доступ после нажатия на расширение. Для демонстрационного процесса не требуется постоянный доступ ко всем сайтам.",
        points: [
      ...
      },
      {
        ...
        body: "Визуальный режим сохраняет исходный вид. Редактируемый режим воссоздаёт поддерживаемый текст, изображения и ссылки и показывает предупреждения о заменах.",
      },
      {
        heading: "Для длинных и закрытых материалов",
        body: "Расширение рассчитано на страницы с авторизацией и длинные AI-диалоги, недоступные публичному URL-конвертеру.",
      },
    ],
  ...
  "chrome-extension/welcome": {
    ...
    lead: "Закрепите расширение, откройте нужную страницу, затем выберите PDF или PowerPoint в панели инструментов.",
    sections: [
      {
        heading: "1. Закрепите Page2File",
        body: "Откройте меню расширений и оставьте Page2File видимым на панели инструментов.",
      },
      {
        heading: "2. Откройте источник",
        body: "Перейдите на точную страницу или разговор, который хотите экспортировать.",
      },
      {
        heading: "3. Проверьте перед скачиванием",
        body: "Выберите режим, просмотрите локальные секции и скачайте файл, когда результат вас устраивает.",
      },
    ],
  ...
  privacy: {
    ...
    description:
      "Черновая политика Page2File о временных зашифрованных задачах, коротком хранении файлов, аналитике по умолчанию и отсутствии истории.",
    lead:
  ...
  "cookie-policy": {
    ...
    description:
      "Черновое описание автоматической загрузки GA4, обработки UTM-атрибуции в памяти и поведения аналитики на публичных страницах Page2File.",
    lead:
