...
> = {
  ...
  "one-page2powerpoint-gpt": {
    ...
    sections: [
      ...
      { heading: "2. Получите один PPTX", body: "Страница будет преобразована в одну презентацию PowerPoint. Проверьте границы слайдов и визуальные или редактируемые замены." },
