...
Статус: планирование, без реализации кода.

Этот каталог фиксирует согласованную продуктовую и техническую архитектуру для двух независимых проектов:

- `page2file-web` — Next.js веб-сервис, маркетинговые и SEO-страницы, локализованный контент, preview UI и тонкий BFF;
...
- Сейчас не создаются приложения, package manifests, конфиги, маршруты, компоненты, тесты и инфраструктура.
